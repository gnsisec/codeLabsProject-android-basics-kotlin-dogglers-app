...
class DogCardAdapter(
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        val dataItem = dogs[position]

        // TODO: Set the image resource for the current dog
        holder.dogImage?.setImageResource(dataItem.imageResourceId)

        // TODO: Set the text for the current dog's name
        holder.dogName?.setText(dataItem.name)

        // TODO: Set the text for the current dog's age
        holder.dogAge?.text = context?.getString(R.string.dog_age, dataItem.age)
        ...
        holder.dogHobby?.text = resources?.getString(R.string.dog_hobbies, dataItem.hobbies)
    }
}
